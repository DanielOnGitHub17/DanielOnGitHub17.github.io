        ...
        this.file.arrayBuffer().then(ar=>{
            ...
            let size = text.length
              ...
              , I = setInterval(()=>{
                ...
                this.uploaders[i].open('GET', `../cgi-bin/uploadfiles2.py?username=${user}&files=${JSON.stringify({
                    name: this.name,
                    mode: 'a',
                    which: this.for + 's',
                    n: i,
                ...
                this.uploaders[i].onloadend = ()=>{
                    ...
                    if (f==m) {
                        if (this.for == 'archive') {
                            this.manager.open('GET', `/cgi-bin/testArchive.py?username=${user}&archive=${this.name}`);
                            this.manager.send();
                            this.manager.onload = ()=>{
